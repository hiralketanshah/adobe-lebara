export const getAllowanceDetails = (allowances, allowanceType) => {
  ...
  allowancesArray.forEach((allowance) => {
    if (allowanceType == "Data" && allowance.account.name == "Data") {
      value = allowance?.allowanceValue >= 1024
      ...
      allowanceType == "UKSIM_International_15" &&
      allowance.account.name == "UKSIM_International_15"
    )
      value = allowance?.allowanceValue;
    else if (allowanceType == "UK_Plan_National" && allowance.account.name == "UK_Plan_National")
      value = allowance?.allowanceValue;
    else if (
      allowanceType == "UK_UNL_National_SMS" &&
