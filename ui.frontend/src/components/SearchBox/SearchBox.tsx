    ...
    >
      <Box bgColor="lightenPrimary.500" width="100%" height="max-content">
        ...
        <Box mt="4px" px="4px" py="15px">
          <LebaraText type="subtitle2" color="white" fontWeight="bold">
            Your recent searches
          </LebaraText>
          <Box mt="7px">
            {recentSearches.length > 0 ? (
              recentSearches.map((searchedData: string) => (
                <Badge variant="subtle" backgroundColor="badgeColor" ml="7px">
          ...
          <Box mt="15px">
            <LebaraText type="subtitle2" color="white" fontWeight="bold">
              Most searched from users
            </LebaraText>
            <Box>
              {mostSearchesFromUsers.length > 0 ? (
                mostSearchesFromUsers.map((searchedData: string) => (
                  <Box
                  ...
                  >
                    ...
                    >
                      <LebaraText type="body2">{searchedData}</LebaraText>
                    </Button>
