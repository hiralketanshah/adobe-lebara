...
public class AemUtils {
    ...
    public static String getLinkWithExtension(String payloadPath) {
        if (payloadPath.contains("http") || payloadPath.startsWith("www") || StringUtils.isBlank(payloadPath) || StringUtils.endsWith(payloadPath, LebaraConstants.HTML_EXTENSION)) {
            return payloadPath;
        }
